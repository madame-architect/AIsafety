...
- **Type:** corporate policy/framework
- **Evidence strength:** operational_standard (maturity: C)
- **ID / locator(s):** URL: https://deepmind.google/discover/blog/strengthening-our-frontier-safety-framework/
- **Access:** open
...
- **Type:** corporate policy/framework
- **Evidence strength:** operational_standard (maturity: C)
- **ID / locator(s):** https://www-cdn.anthropic.com/17310f6d70ae5627f55313ed067afc1a762a4068.pdf ; https://www.anthropic.com/rsp-updates
- **Access:** unknown
...
- **Type:** corporate policy/framework
- **Evidence strength:** operational_standard (maturity: C)
- **ID / locator(s):** https://storage.googleapis.com/deepmind-media/DeepMind.com/Blog/introducing-the-frontier-safety-framework/fsf-technical-report.pdf ; https://deepmind.google/blog/introducing-the-frontier-safety-framework/
- **Access:** unknown
...
- **Type:** standard/guidance
- **Evidence strength:** operational_standard (maturity: C)
- **ID / locator(s):** https://doi.org/10.6028/NIST.AI.800-1.ipd ; https://nvlpubs.nist.gov/nistpubs/ai/NIST.AI.800-1.ipd.pdf
- **Access:** unknown
...
#### `LHLK2TndTrainingComputeThresholds` — Training Compute Thresholds: Features and Functions in AI Regulation (n.d.)
...
- **Type:** regulation
- **Evidence strength:** binding_regulation (maturity: C)
- **ID / locator(s):** PDF: https://heim.xyz/papers/training_compute_thresholds.pdf
- **Access:** open
...
## 3.2 Tier 1 — Technical safety core (112 references)

## Evaluations, benchmarks, and red teaming (23 references)
...
- **Type:** paper
- **Evidence strength:** empirical_small (maturity: B)
- **ID / locator(s):** https://arxiv.org/abs/2508.00943
- **Access:** unknown
...
- **Type:** benchmark/evaluation suite
- **Evidence strength:** benchmark_infra (maturity: B)
- **ID / locator(s):** https://arxiv.org/abs/2410.01606
- **Access:** unknown
...
- **Type:** benchmark/evaluation suite
- **Evidence strength:** benchmark_infra (maturity: B)
- **ID / locator(s):** https://arxiv.org/abs/2408.12798
- **Access:** unknown
...
- **Type:** benchmark/evaluation suite
- **Evidence strength:** benchmark_infra (maturity: A)
- **ID / locator(s):** https://arxiv.org/abs/2402.04249
- **Access:** unknown
...
- **Type:** benchmark/evaluation suite
- **Evidence strength:** benchmark_infra (maturity: B)
- **ID / locator(s):** https://arxiv.org/abs/2409.16783
- **Access:** unknown
...
- **Type:** benchmark/evaluation suite
- **Evidence strength:** benchmark_infra (maturity: A)
- **ID / locator(s):** https://arxiv.org/abs/2404.01318
- **Access:** unknown
...
- **Creators:** Benton et al.
- **Venue/body:** —
- **Year:** 2024
- **Type:** paper
- **Evidence strength:** empirical_small (maturity: B)
- **ID / locator(s):** https://arxiv.org/abs/2410.21514
- **Access:** unknown
...
- **Threat model:** insider
- **Method area:** evaluation/benchmarks
- **Provenance:** S1‑M‑05 (deep-research-report (2).md)
...
- **Type:** benchmark/evaluation suite
- **Evidence strength:** benchmark_infra (maturity: A)
- **ID / locator(s):** https://arxiv.org/abs/2403.03218 ; https://wmdp.ai/
- **Access:** unknown
...
- **Type:** paper
- **Evidence strength:** empirical_small (maturity: B)
- **ID / locator(s):** https://arxiv.org/abs/2411.15477
- **Access:** unknown
...
## Agentic risk, deception, and control (10 references)
...
- **Type:** paper
- **Evidence strength:** empirical_small (maturity: B)
- **ID / locator(s):** https://openreview.net/forum?id=It2Nwp7QSy
- **Access:** unknown
...
- **Venue/body:** arXiv
- **Year:** 2024
- **Where/what:** arXiv:2412.14093, 2024.
- **Type:** paper
- **Evidence strength:** empirical_small (maturity: B)
...
- **Threat model:** adaptive attacker
- **Method area:** post-training/alignment
- **Provenance:** TECH-057 (deep-research-report.md)
...
- **Creators:** Meinke et al.
- **Venue/body:** —
- **Year:** 2024
- **Type:** paper
- **Evidence strength:** empirical_small (maturity: B)
- **ID / locator(s):** https://arxiv.org/abs/2406.11713
- **Access:** unknown
...
- **Assurance function:** eval; mitigation; reporting
- **Threat model:** insider
- **Provenance:** S1‑E‑07 (deep-research-report (2).md)
...
- **Type:** paper
- **Evidence strength:** empirical_small (maturity: B)
- **ID / locator(s):** https://arxiv.org/abs/2311.07590
- **Access:** unknown
...
## Monitoring and monitorability (7 references)
...
- **Creators:** Korbak et al.
- **Venue/body:** —
- **Year:** 2025
- **Type:** paper
- **Evidence strength:** empirical_small (maturity: B)
- **ID / locator(s):** https://arxiv.org/abs/2507.11473
- **Access:** unknown
...
- **Threat model:** —
- **Method area:** monitoring
- **Provenance:** S1‑M‑01 (deep-research-report (2).md)
...
- **Type:** paper
- **Evidence strength:** empirical_small (maturity: B)
- **ID / locator(s):** https://arxiv.org/abs/2512.18311 ; https://cdn.openai.com/papers/monitoring-monitorability.pdf
- **Access:** unknown
...
- **Type:** paper
- **Evidence strength:** empirical_scaled (maturity: B)
- **ID / locator(s):** https://arxiv.org/abs/2504.18530
- **Access:** unknown
...
- **Creators:** Kenton et al.
- **Venue/body:** —
- **Year:** 2024
- **Type:** paper
- **Evidence strength:** empirical_small (maturity: B)
- **ID / locator(s):** https://arxiv.org/abs/2407.04622
- **Access:** unknown
...
- **Threat model:** —
- **Method area:** monitoring
- **Provenance:** S1‑SO‑01 (deep-research-report (2).md)

#### `OpenAIndEvaluatingChainofthoughtMonito` — Evaluating chain‑of‑thought monitorability (n.d.)
- **Creators:** OpenAI
- **Venue/body:** —
- **Year:** n.d.
- **Type:** paper
- **Evidence strength:** benchmark_infra (maturity: B)
- **ID / locator(s):** https://openai.com/index/evaluating-chain-of-thought-monitorability/ ; https://arxiv.org/abs/2512.18311
- **Access:** unknown
- **Annotation:** Introduces a framework and suite of evaluations intended to track monitorability across models/environments, emphasizing that longer reasoning can improve monitorability.
- **Safety relevance:** Converts monitorability into an evaluable artifact that can be incorporated into governance reporting and safety‑case evidence.
- **Limitations / open questions:** Evaluation suites can be gamed; monitorability under adversarial pressure needs continual stress testing.
- **Risk domain:** —
- **Lifecycle stage:** deployment
- **Assurance function:** monitoring; reporting
- **Threat model:** —
- **Method area:** monitoring
- **Provenance:** S1‑M‑02 (deep-research-report (2).md)

## Security, jailbreaks, and supply-chain risks (14 references)
...
- **Type:** policy report/guidance
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://arxiv.org/abs/2601.04603
- **Access:** unknown
...
- **Type:** paper
- **Evidence strength:** empirical_small (maturity: B)
- **ID / locator(s):** https://arxiv.org/abs/2501.18837
- **Access:** unknown
...
- **Type:** paper
- **Evidence strength:** empirical_small (maturity: B)
- **ID / locator(s):** https://arxiv.org/abs/2504.09604
- **Access:** unknown
...
- **Threat model:** adaptive attacker
- **Method area:** security
- **Provenance:** S1‑E‑04 (deep-research-report (2).md)
...
- **Type:** standard/guidance
- **Evidence strength:** operational_standard (maturity: C)
- **ID / locator(s):** https://arxiv.org/abs/2410.13722
- **Access:** unknown
...
- **Type:** paper
- **Evidence strength:** empirical_scaled (maturity: B)
- **ID / locator(s):** https://www-cdn.anthropic.com/af5633c94ed2beb282f6a53c595eb437e8e7b630/Many_Shot_Jailbreaking__2024_04_02_0936.pdf ; https://openreview.net/forum?id=cw5mgd71jW
- **Access:** unknown
...
#### `HuangndEndlessJailbreaksBijection` — Endless Jailbreaks with Bijection Learning (n.d.)
- **Creators:** Huang et al.
- **Venue/body:** —
- **Year:** n.d.
- **Type:** paper
- **Evidence strength:** empirical_small (maturity: B)
- **ID / locator(s):** https://arxiv.org/abs/2410.01294
- **Access:** unknown
...
- **Type:** paper
- **Evidence strength:** empirical_small (maturity: B)
- **ID / locator(s):** https://openreview.net/forum?id=XxYNlbTFYS
- **Access:** unknown
...
- **Type:** paper
- **Evidence strength:** empirical_small (maturity: B)
- **ID / locator(s):** https://arxiv.org/abs/2601.01887
- **Access:** unknown
...
- **Type:** paper
- **Evidence strength:** empirical_small (maturity: B)
- **ID / locator(s):** https://arxiv.org/abs/2505.24369
- **Access:** unknown
...
- **Type:** paper
- **Evidence strength:** empirical_small (maturity: B)
- **ID / locator(s):** https://openreview.net/forum?id=HZVIQE1MsJ
- **Access:** unknown
...
- **Type:** paper
- **Evidence strength:** empirical_small (maturity: B)
- **ID / locator(s):** https://arxiv.org/abs/2406.05946
- **Access:** unknown
...
- **Type:** paper
- **Evidence strength:** empirical_small (maturity: B)
- **ID / locator(s):** https://arxiv.org/abs/2311.17035 ; https://openreview.net/forum?id=vjel3nWP2a
- **Access:** unknown
...
- **Type:** paper
- **Evidence strength:** benchmark_infra (maturity: B)
- **ID / locator(s):** https://arxiv.org/abs/2504.01903 ; https://ucsc-vlaa.github.io/STAR-1/
- **Access:** unknown
...
- **Type:** paper
- **Evidence strength:** empirical_small (maturity: B)
- **ID / locator(s):** https://arxiv.org/abs/2412.16339
- **Access:** unknown
...
- **Type:** paper
- **Evidence strength:** empirical_small (maturity: B)
- **ID / locator(s):** https://arxiv.org/abs/2408.15240
- **Access:** unknown
...
- **Type:** paper
- **Evidence strength:** empirical_small (maturity: B)
- **ID / locator(s):** https://arxiv.org/abs/2405.19332
- **Access:** unknown
...
- **Type:** paper
- **Evidence strength:** empirical_small (maturity: B)
- **ID / locator(s):** https://arxiv.org/abs/2504.01550
- **Access:** unknown
...
- **Type:** paper
- **Evidence strength:** empirical_small (maturity: B)
- **ID / locator(s):** https://arxiv.org/abs/2501.17727
- **Access:** unknown
...
- **Type:** standard/guidance
- **Evidence strength:** operational_standard (maturity: C)
- **ID / locator(s):** https://arxiv.org/abs/2407.02646
- **Access:** unknown
...
- **Type:** paper
- **Evidence strength:** empirical_scaled (maturity: B)
- **ID / locator(s):** https://arxiv.org/abs/2410.13928 ; https://openreview.net/forum?id=5lIXRf8Lnw
- **Access:** unknown
...
- **Type:** paper
- **Evidence strength:** empirical_scaled (maturity: B)
- **ID / locator(s):** https://transformer-circuits.pub/2024/scaling-monosemanticity/
- **Access:** unknown
...
- **Type:** paper
- **Evidence strength:** empirical_small (maturity: B)
- **ID / locator(s):** https://arxiv.org/abs/2309.08600 ; https://openreview.net/forum?id=F76bwRSLeK
- **Access:** unknown
...
- **Type:** policy report/guidance
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://transformer-circuits.pub/2025/attribution-graphs/methods.html ; https://www.anthropic.com/research/tracing-thoughts-language-model
- **Access:** unknown
...
- **Type:** policy report/guidance
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://arxiv.org/abs/2501.13124
- **Access:** unknown
...
- **Type:** policy report/guidance
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://transformer-circuits.pub/2025/attribution-graphs/biology.html ; https://www.anthropic.com/research/tracing-thoughts-language-model
- **Access:** unknown
...
- **Type:** policy report/guidance
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://transformer-circuits.pub/2025/attention-qk/index.html
- **Access:** unknown
...
- **Type:** policy report/guidance
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://arxiv.org/abs/2312.12321
- **Access:** unknown
...
- **Type:** policy report/guidance
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://arxiv.org/abs/2402.16822
- **Access:** unknown
...
- **Type:** policy report/guidance
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://arxiv.org/abs/2409.20089
- **Access:** unknown
...
- **Type:** policy report/guidance
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://arxiv.org/abs/2405.16833
- **Access:** unknown
...
- **Type:** policy report/guidance
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://arxiv.org/abs/2408.00761
- **Access:** unknown
...
- **Type:** policy report/guidance
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://arxiv.org/search/?query=Training+LLMs+to+Prioritize+Privileged+Instructions&searchtype=all&source=header
- **Access:** unknown
...
## 3.3 Tier 2 — Extended governance references (brief notes) (61 references)
...
- **Type:** policy report/guidance
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://internationalaisafetyreport.org/sites/default/files/2026-02/international-ai-safety-report-2026.pdf
- **Access:** unknown
...
- **Type:** policy report/guidance
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://internationalaisafetyreport.org/
- **Access:** unknown
...
- **Assurance function:** reporting
- **Threat model:** —
- **Provenance:** S2‑T2‑38 (deep-research-report (2).md)
...
- **Type:** paper
- **Evidence strength:** empirical_small (maturity: B)
- **ID / locator(s):** https://www.weforum.org/reports/global-cybersecurity-outlook-2026/
- **Access:** unknown
...
- **Type:** industry report
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://www.frontiermodelforum.org/research-updates/frontier-ai-and-nuclear-security/
- **Access:** unknown
...
- **Type:** policy report/guidance
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://oecd.ai/en/incidents
- **Access:** unknown
...
#### `OPRLHR20252025` — 2025) (2025)
- **Creators:** OECD press release launching HAIP Reporting Framework (Feb 7
- **Venue/body:** OECD press release launching HAIP Reporting Framework (Feb 7
- **Year:** 2025
- **Type:** policy report/guidance
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://www.oecd.org/en/events/2025/02/launch-of-the-hiroshima-ai-process-reporting-framework.html
- **Access:** unknown
- **Annotation:** Official OECD framing of HAIP reporting as “first global framework” for reporting on safe/secure/trustworthy AI; gap is verification of self‑reported claims / Industry feedback loop into standards; indicates convergence on TEVV importance, but also highlights unsettled details / Clarifies mandate emphasis (security framing); does not by itself specify evaluation standards / Demonstrates governance volatility; safety continuity depends on durable institutional processes rather than single executive actions.
- **Risk domain:** —
- **Lifecycle stage:** deployment
- **Assurance function:** reporting
- **Threat model:** —
- **Provenance:** S2‑T2‑10, S2‑T2‑24, S2‑T2‑34, S2‑T2‑49, S2‑T3‑23, S2‑T3‑24 (deep-research-report (2).md)
...
- **Type:** corporate policy/framework
- **Evidence strength:** operational_standard (maturity: C)
- **ID / locator(s):** https://openai.com/index/updating-our-preparedness-framework/
- **Access:** unknown
...
- **Type:** policy report/guidance
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://digital-strategy.ec.europa.eu/en/policies/general-purpose-ai-code-practice
- **Access:** unknown
...
- **Type:** policy report/guidance
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://apnews.com/hub/artificial-intelligence
- **Access:** unknown
...
- **Type:** policy report/guidance
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://deepmind.google/blog/strengthening-our-frontier-safety-framework/ ; https://storage.googleapis.com/deepmind-media/DeepMind.com/Blog/strengthening-our-frontier-safety-framework/frontier-safety-framework_3.pdf
- **Access:** unknown
...
- **Type:** policy report/guidance
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://www.federalregister.gov/documents/2025/01/15/2025-00636/framework-for-artificial-intelligence-diffusion
- **Access:** unknown
...
- **Creators:** US Federal Register interim final rule “Framework for Artificial Intelligence Diffusion” (Jan 15
- **Venue/body:** US Federal Register interim final rule “Framework for Artificial Intelligence Diffusion” (Jan 15
- **Year:** 2025
- **Type:** policy report/guidance
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://www.federalregister.gov/documents/2025/01/15/2025-00636/framework-for-artificial-intelligence-diffusion
- **Access:** unknown
- **Annotation:** Expands diffusion/export controls, including controls on certain advanced model weights; safety depends on preventing misuse while managing innovation and compliance complexity.
- **Risk domain:** open-weights
- **Lifecycle stage:** —
- **Assurance function:** reporting
- **Threat model:** —
- **Provenance:** S2‑T2‑17 (deep-research-report (2).md)
...
- **Type:** corporate policy/framework
- **Evidence strength:** operational_standard (maturity: C)
- **ID / locator(s):** https://storage.googleapis.com/deepmind-media/DeepMind.com/Blog/strengthening-our-frontier-safety-framework/frontier-safety-framework_3.pdf
- **Access:** unknown
...
- **Threat model:** —
- **Method area:** governance
- **Provenance:** S2‑T2‑30 (deep-research-report (2).md)
...
- **Type:** policy report/guidance
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://transparency.oecd.ai/
- **Access:** unknown
...
- **Type:** policy report/guidance
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://www.frontiermodelforum.org/updates/introducing-the-fmfs-technical-report-series-on-frontier-ai-safety-frameworks/
- **Access:** unknown
...
- **Type:** paper
- **Evidence strength:** empirical_small (maturity: B)
- **ID / locator(s):** https://www.frontiermodelforum.org/publications/
- **Access:** unknown
...
- **Type:** corporate policy/framework
- **Evidence strength:** operational_standard (maturity: C)
- **ID / locator(s):** https://cdn.openai.com/pdf/18a02b5d-6b67-4cec-ab64-68cdfbddebcd/preparedness-framework-v2.pdf ; https://openai.com/index/updating-our-preparedness-framework/
- **Access:** unknown
...
- **Type:** policy report/guidance
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://www.gov.ca.gov/
- **Access:** unknown
...
- **Type:** policy report/guidance
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://www.rand.org/pubs.html
- **Access:** unknown
...
- **Type:** policy report/guidance
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://www.parliament.uk/business/publications/written-questions-answers-statements/written-statements/
- **Access:** unknown
...
- **Type:** policy report/guidance
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://www.federalregister.gov/documents/2024/09/11/2024-20529/establishment-of-reporting-requirements-for-the-development-of-advanced-artificial-intelligence
- **Access:** unknown
...
- **Type:** regulation
- **Evidence strength:** binding_regulation (maturity: C)
- **ID / locator(s):** https://eur-lex.europa.eu/eli/reg/2024/1689/oj
- **Access:** unknown
...
- **Type:** policy report/guidance
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://www.sba.gov/document/report-artificial-intelligence-compliance-plan-omb-memorandum-m-24-10
- **Access:** unknown
...
- **Type:** policy report/guidance
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://www.eac.gov/sites/default/files/2024-10/EAC_Compliance_Plan_OMB_Memorandum_FINAL_508.pdf
- **Access:** unknown
...
- **Type:** policy report/guidance
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://img.exim.gov/s3fs-public/documents/EXIM%20Compliance%20Plan%20for%20OMB%20Memorandum%20M-24-10Final.pdf
- **Access:** unknown
...
- **Type:** policy report/guidance
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://www.aisi.gov.uk/blog/fourth-progress-report
- **Access:** unknown
...
- **Type:** policy report/guidance
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://www.un.org/ai-advisory-body
- **Access:** unknown
...
- **Type:** policy report/guidance
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://www.whitehouse.gov/wp-content/uploads/2024/03/M-24-10-Advancing-Governance-Innovation-and-Risk-Management-for-Agency-Use-of-Artificial-Intelligence.pdf
- **Access:** unknown
...
- **Type:** corporate policy/framework
- **Evidence strength:** operational_standard (maturity: C)
- **ID / locator(s):** https://openai.com/index/openai-o1-system-card/ ; https://cdn.openai.com/o1-system-card.pdf
- **Access:** unknown
...
- **Type:** corporate policy/framework
- **Evidence strength:** operational_standard (maturity: C)
- **ID / locator(s):** https://www.anthropic.com/rsp-updates
- **Access:** unknown
...
- **Threat model:** —
- **Method area:** governance
- **Provenance:** S2‑T2‑28 (deep-research-report (2).md)
...
- **Type:** policy report/guidance
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://www.state.gov/
- **Access:** unknown
...
- **Type:** policy report/guidance
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://www.federalregister.gov/documents/2023/11/06/2023-24283/safe-secure-and-trustworthy-development-and-use-of-artificial-intelligence
- **Access:** unknown
...
#### `EUndAiActPolicy` — AI Act policy page (n.d.)
- **Creators:** EU
- **Venue/body:** EU
- **Year:** n.d.
- **Type:** regulation
...
- **ID / locator(s):** https://eur-lex.europa.eu/eli/reg/2024/1689/oj
- **Access:** unknown
- **Annotation:** Supports compliance scheduling; ongoing delegated standards will determine real requirements.
- **Risk domain:** —
- **Lifecycle stage:** —
- **Assurance function:** reporting
- **Threat model:** —
- **Method area:** governance
- **Provenance:** S2‑T2‑64, S2‑T3‑69 (deep-research-report (2).md)

#### `UNndAiAdvisoryBody` — AI Advisory Body landing page (n.d.)
- **Creators:** UN
- **Venue/body:** UN
- **Year:** n.d.
- **Type:** standard/guidance
...
- **ID / locator(s):** https://www.un.org/ai-advisory-body
- **Access:** unknown
- **Annotation:** Official access point for UN recommendations; does not specify implementation commitments.
- **Risk domain:** —
- **Lifecycle stage:** —
- **Assurance function:** reporting
- **Threat model:** —
- **Provenance:** S2‑T2‑51, S2‑T3‑18 (deep-research-report (2).md)

#### `OECDndAiDashboardEntry` — AI dashboard entry on HLAB‑AI initiative (n.d.)
- **Creators:** OECD
- **Venue/body:** OECD
- **Year:** n.d.
- **Type:** policy report/guidance
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://oecd.ai/en/
- **Access:** unknown
...
#### `NationalndAiSafetyInstitutes` — AI safety institutes: joint pre‑deployment testing report on OpenAI o1 (n.d.)
- **Creators:** National
- **Venue/body:** National
- **Year:** n.d.
- **Type:** policy report/guidance
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://www.aisi.gov.uk/
- **Access:** unknown
...
- **Type:** standard/guidance
- **Evidence strength:** operational_standard (maturity: C)
- **ID / locator(s):** https://airmf.nist.gov/
- **Access:** unknown
...
- **Type:** industry report
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://www.frontiermodelforum.org/workstreams/ai-bio-workstream/
- **Access:** unknown
...
- **Type:** industry report
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://www.frontiermodelforum.org/workstreams/ai-cyber-workstream/
- **Access:** unknown
...
- **Type:** industry report
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://www.frontiermodelforum.org/workstreams/ai-nuclear-workstream/
- **Access:** unknown
...
#### `EuropeanndCommissionPresscornerPdf` — Commission press‑corner PDF on AI Act (n.d.)
- **Creators:** European
- **Venue/body:** European
- **Year:** n.d.
- **Type:** regulation
...
- **ID / locator(s):** https://eur-lex.europa.eu/eli/reg/2024/1689/oj
- **Access:** unknown
- **Annotation:** Connects AI Act governance to implementation institutions; governance capacity and harmonized standards remain gating constraints.
- **Risk domain:** —
- **Lifecycle stage:** —
- **Assurance function:** reporting
- **Threat model:** —
- **Method area:** governance
- **Provenance:** S2‑T2‑41 (deep-research-report (2).md)
...
- **Type:** policy report/guidance
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://www.cio.gov/ai/
- **Access:** unknown
...
#### `EUndDrawingupGeneralpurposeAi` — Drawing‑up a General‑Purpose AI Code of Practice (n.d.)
- **Creators:** EU
- **Venue/body:** EU
- **Year:** n.d.
- **Type:** policy report/guidance
...
- **ID / locator(s):** https://digital-strategy.ec.europa.eu/en/policies/general-purpose-ai-code-practice
- **Access:** unknown
- **Annotation:** Describes the Code’s role as a voluntary tool to help meet AI Act GPAI rules; the gap is how “voluntary” interacts with enforcement expectations.
- **Risk domain:** —
- **Lifecycle stage:** —
- **Assurance function:** reporting
- **Threat model:** —
- **Method area:** governance
- **Provenance:** S2‑T2‑08 (deep-research-report (2).md)

#### `RMCECndFirmsResisting` — firms resisting) (n.d.)
- **Creators:** Reuters / media context on EU Code of Practice uptake/disputes (e.g.
- **Venue/body:** —
- **Year:** n.d.
- **Type:** press coverage
- **Evidence strength:** conceptual (maturity: D)
- **ID / locator(s):** https://www.reuters.com/technology/
- **Access:** unknown
...
- **Type:** policy report/guidance
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://www.aisi.gov.uk/frontier-ai-trends-report ; https://aisi.s3.eu-west-2.amazonaws.com/Frontier%2BAI%2BTrends%2BReport%2B-%2BAI%2BSecurity%2BInstitute.pdf
- **Access:** unknown
...
#### `UILndGoverningAiHumanity` — Governing AI for Humanity (n.d.)
- **Creators:** UN iLibrary listing of
- **Venue/body:** UN iLibrary listing of
- **Year:** n.d.
- **Type:** policy report/guidance
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://www.un.org/ai-advisory-body
- **Access:** unknown
- **Annotation:** Confirms publication date and access; the report’s recommendations require translation into enforceable instruments.
- **Risk domain:** —
- **Lifecycle stage:** —
- **Assurance function:** reporting
- **Threat model:** —
- **Provenance:** S2‑T2‑52, S2‑T3‑17 (deep-research-report (2).md)

#### `NISTndManagingMisuseRisk` — Managing Misuse Risk for Dual‑Use Foundation Models (n.d.)
- **Creators:** NIST
- **Venue/body:** NIST
- **Year:** n.d.
- **Type:** standard/guidance
...
- **ID / locator(s):** https://doi.org/10.6028/NIST.AI.800-1.ipd ; https://nvlpubs.nist.gov/nistpubs/ai/NIST.AI.800-1.ipd.pdf
- **Access:** unknown
- **Annotation:** Frames dual‑use misuse risk management for foundation models; key for CBRN/cyber governance, but draft status and mapping to enforceable obligations remains evolving.
- **Risk domain:** cyber; CBRN
- **Lifecycle stage:** —
- **Assurance function:** eval; reporting
- **Threat model:** —
- **Method area:** evaluation/benchmarks
- **Provenance:** S2‑T2‑02, S2‑T3‑02 (deep-research-report (2).md)

#### `MappingndMappingAiBenchmark` — Mapping AI benchmark data to quantitative risk estimates (n.d.)
- **Creators:** TBD
- **Venue/body:** —
- **Year:** n.d.
- **Type:** benchmark/evaluation suite
...
#### `ReutersndNoStopClock` — no stop the clock (n.d.)
- **Creators:** Reuters
- **Venue/body:** —
- **Year:** n.d.
- **Type:** press coverage
- **Evidence strength:** conceptual (maturity: D)
- **ID / locator(s):** https://www.reuters.com/world/europe/
- **Access:** unknown
...
#### `ASIBndOurFirstYear` — Our First Year (n.d.)
...
- **Type:** standard/guidance
- **Evidence strength:** operational_standard (maturity: C)
- **ID / locator(s):** https://www.nist.gov/artificial-intelligence
- **Access:** unknown
...
- **Type:** policy report/guidance
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://digital-strategy.ec.europa.eu/en/policies/european-approach-artificial-intelligence
- **Access:** unknown
...
- **Type:** policy report/guidance
- **Evidence strength:** conceptual (maturity: C)
- **ID / locator(s):** https://controlarena.ai/
- **Access:** unknown
...
#### `FMFndResearchUpdateNuclear` — research update on nuclear security (n.d.)
- **Creators:** FMF
- **Venue/body:** FMF
- **Year:** n.d.
- **Type:** industry report
...
- **ID / locator(s):** https://www.frontiermodelforum.org/research-updates/frontier-ai-and-nuclear-security/
- **Access:** unknown
- **Annotation:** Highlights AI as accelerant to existing nuclear threats; needs measurable evaluation methodologies.
- **Risk domain:** CBRN
- **Lifecycle stage:** deployment
- **Assurance function:** eval; reporting
- **Threat model:** —
- **Method area:** security
- **Provenance:** S2‑T2‑67 (deep-research-report (2).md)

#### `AISIndTacklingAiSecurity` — Tackling AI security risks… (n.d.)
- **Creators:** AISI
- **Venue/body:** AISI
- **Year:** n.d.
- **Type:** policy report/guidance
